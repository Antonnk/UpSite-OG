                      ...
                      return _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "absolute pin-t pin-r btn btn-sm btn-white bg-white m-4",
          ...
          _c("div", { staticClass: "flex-1" }, [
            ...
            _c(
              ...
              [
                _c("editor", {
                  model: {
                    value: _vm.content.contact.address.street,
                    callback: function($$v) {
                      _vm.$set(_vm.content.contact.address, "street", $$v)
                    },
                    expression: "content.contact.address.street"
                  }
                }),
                _c("br"),
                _vm._v(" "),
                _c("editor", {
                  staticClass: "no-icon",
                  model: {
                    value: _vm.content.contact.address.postcode,
                    callback: function($$v) {
                      _vm.$set(_vm.content.contact.address, "postcode", $$v)
                    },
                    expression: "content.contact.address.postcode"
                  }
                }),
                _vm._v(" "),
                _c("editor", {
                  ...
                  model: {
                    ...
                    callback: function($$v) {
                      _vm.$set(_vm.content.contact.address, "city", $$v)
                    },
                    expression: "content.contact.address.city"
                  }
                })
              ],
              1
