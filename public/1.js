  ...
  return _c("main", { staticClass: "h-screen font-sans" }, [
          ...
          [
            _c(
              ...
              [
                _c("h1", {
                  staticClass:
                    "text-center text-orange text-6xl max-w-full break-words",
                  domProps: { textContent: _vm._s(_vm.content.name) }
                }),
                _vm._v(" "),
                _c("h2", {
                  staticClass:
                    "font-light text-2xl text-center text-orange word-break max-w-xs",
                  domProps: { textContent: _vm._s(_vm.content.title) }
                })
              ]
            ),
            _vm._v(" "),
            _c(
              ...
              [
                _c("div", { staticClass: "text-center p-4 w-full md:w-1/3" }, [
                  ...
                  _vm._v(" "),
                  _c("address", { staticClass: "text-white font-semibold" }, [
                    _vm._v(
                      "\n\t\t\t\t\t\t" +
                      ...
                      "\n\t\t\t\t\t\t" +
                        _vm._s(
                          _vm.content.contact.address.postcode +
                            " " +
                            _vm.content.contact.address.city
                        ) +
                        "\n\t\t\t\t\t"
                    )
                  ])
    ...
    _c("section", { staticClass: "flex-col md:flex-row flex" }, [
      ...
      _c(
        ...
        [
          _c("h2", {
            staticClass: "mb-5 text-5xl break-words",
            domProps: { innerHTML: _vm._s(_vm.content.intro_title) }
          }),
          _vm._v(" "),
          _c("p", {
            staticClass: "break-words",
            domProps: { innerHTML: _vm._s(_vm.content.intro) }
          })
        ]
      )
    ]),
        ...
        _c("div", { staticClass: "flex justify-center py-20" }, [
          _c("div", { staticClass: "container" }, [
            _c("h2", {
              ...
              domProps: { textContent: _vm._s(_vm.content.menu_title) }
            }),
            _vm._v(" "),
            _c(
              "ul",
    ...
    _c("section", { staticClass: "bg-black flex-1 py-16 px-6 text-white" }, [
      _c("div", { staticClass: "container mx-auto" }, [
        _c("div", { staticClass: "flex items-center mb-4 text-lg" }, [
          ...
          _vm._v(" "),
          _c("span", {
            domProps: { textContent: _vm._s(_vm.content.contact.email) }
          })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "flex items-center mb-4 text-lg" }, [
          ...
          _vm._v(" "),
          _c("span", {
            domProps: { textContent: _vm._s(_vm.content.social.facebook) }
          })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "flex items-center mb-4 text-lg" }, [
          ...
          _vm._v(" "),
          _c("span", {
            domProps: { textContent: _vm._s(_vm.content.social.instagram) }
          })
        ])
      ])
    ])
